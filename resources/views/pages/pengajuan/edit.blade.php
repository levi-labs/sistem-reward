        ...
        <div class="col-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample mt-5" action="{{ url('/update-pengajuan/' . $pengajuan->id) }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="npk">NPK</label>
                            <input type="text" class="form-control" id="npk" placeholder="npk" name="npk"
                                value="{{ $pengajuan->karyawans->npk }}" disabled>
                        </div>
                        <div class="form-group">
                            <label for="nama">Nama</label>
                            <input type="text" class="form-control" id="nama" placeholder="Name" name="nama"
                                value="{{ $pengajuan->karyawans->nama }}" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="status_karyawan">
                                    ...
                                    <option {{ $pengajuan->status_karyawan == 'Karyawan Tetap' ? 'selected' : '' }}>Karyawan
                                        Tetap</option>
                                    <option {{ $pengajuan->status_karyawan == 'Karyawan Kontrak' ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleTextarea1" rows="4" name="kondisi_sebelum">{{ $pengajuan->kondisi_sebelum }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea1">Kondisi Sesudah Perbaikan </label>
                            <textarea class="form-control" id="exampleTextarea1" rows="4" name="kondisi_sesudah">{{ $pengajuan->kondisi_sesudah }}</textarea>
                        </div>
